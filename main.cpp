...
int main(){
	...
	string inputFilePath = "/home/sergey/Books/coursera-c++brown-4/Экзамен - граф/transport-input2.json";
	...
	string outputFilePath = "/home/sergey/Books/coursera-c++brown-4/result2.json";
